...
+(HttpRequest*)HTTPRequestWithUrl:(NSString*)HttpURL andData:(NSString*)PostData andMethod:(NSString*)Method andUserName:(NSString*)UserName andPassword:(NSString*)Password andTimeout:(float)timeout{
...
//    NSLog(@"postLength=%@",postLength);
    ...
    //设置提交目的url
    NSString* URL = [HttpURL stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
